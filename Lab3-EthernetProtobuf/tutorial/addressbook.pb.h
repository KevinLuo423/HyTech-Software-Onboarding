...
namespace protobuf {
template <>
internal::EnumTraitsT<::Lab3::Person_PhoneType_internal_data_>
    internal::EnumTraitsImpl::value<::Lab3::Person_PhoneType>;
}  // namespace protobuf
}  // namespace google
...
/* @@protoc_insertion_point(class_definition:Lab3.Person.PhoneNumber) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "Lab3.Person.PhoneNumber"; }
 ...
 public:
  ...
  public:
  // .Lab3.Person.PhoneType type = 2;
  void clear_type() ;
  ::Lab3::Person_PhoneType type() const;
  void set_type(::Lab3::Person_PhoneType value);

  private:
  ::Lab3::Person_PhoneType _internal_type() const;
  void _internal_set_type(::Lab3::Person_PhoneType value);

  public:
  // @@protoc_insertion_point(class_scope:Lab3.Person.PhoneNumber)
 private:
  class _Internal;
...
/* @@protoc_insertion_point(class_definition:Lab3.Person) */ {
 public:
 ...
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "Lab3.Person"; }
 ...
 public:
  ...
  // repeated .Lab3.Person.PhoneNumber phones = 4;
  ...
  public:
  void clear_phones() ;
  ::Lab3::Person_PhoneNumber* PROTOBUF_NONNULL mutable_phones(int index);
  ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>* PROTOBUF_NONNULL mutable_phones();

  private:
  const ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>& _internal_phones() const;
  ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>* PROTOBUF_NONNULL _internal_mutable_phones();
  public:
  const ::Lab3::Person_PhoneNumber& phones(int index) const;
  ::Lab3::Person_PhoneNumber* PROTOBUF_NONNULL add_phones();
  const ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>& phones() const;
  // string name = 1;
  void clear_name() ;
  ...
  public:
  // @@protoc_insertion_point(class_scope:Lab3.Person)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::RepeatedPtrField< ::Lab3::Person_PhoneNumber > phones_;
...
/* @@protoc_insertion_point(class_definition:Lab3.AddressBook) */ {
 public:
 ...
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "Lab3.AddressBook"; }
 ...
 public:
  ...
  public:
  void clear_people() ;
  ::Lab3::Person* PROTOBUF_NONNULL mutable_people(int index);
  ::google::protobuf::RepeatedPtrField<::Lab3::Person>* PROTOBUF_NONNULL mutable_people();

  private:
  const ::google::protobuf::RepeatedPtrField<::Lab3::Person>& _internal_people() const;
  ::google::protobuf::RepeatedPtrField<::Lab3::Person>* PROTOBUF_NONNULL _internal_mutable_people();
  public:
  const ::Lab3::Person& people(int index) const;
  ::Lab3::Person* PROTOBUF_NONNULL add_people();
  const ::google::protobuf::RepeatedPtrField<::Lab3::Person>& people() const;
  // @@protoc_insertion_point(class_scope:Lab3.AddressBook)
 private:
  class _Internal;
  friend class ::google::protobuf::internal::TcParser;
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::Lab3::Person > people_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
  };
  union { Impl_ _impl_; };
...
inline const ::std::string& Person_PhoneNumber::number() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Lab3.Person.PhoneNumber.number)
...
PROTOBUF_ALWAYS_INLINE void Person_PhoneNumber::set_number(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:Lab3.Person.PhoneNumber.number)
}
inline ::std::string* PROTOBUF_NONNULL Person_PhoneNumber::mutable_number()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_number();
  // @@protoc_insertion_point(field_mutable:Lab3.Person.PhoneNumber.number)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Person_PhoneNumber::release_number() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Lab3.Person.PhoneNumber.number)
...
inline void Person_PhoneNumber::set_allocated_number(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Lab3.Person.PhoneNumber.number)
}
...
inline ::Lab3::Person_PhoneType Person_PhoneNumber::type() const {
  // @@protoc_insertion_point(field_get:Lab3.Person.PhoneNumber.type)
  return _internal_type();
}
inline void Person_PhoneNumber::set_type(::Lab3::Person_PhoneType value) {
  _internal_set_type(value);
  _impl_._has_bits_[0] |= 0x00000002U;
  // @@protoc_insertion_point(field_set:Lab3.Person.PhoneNumber.type)
}
inline ::Lab3::Person_PhoneType Person_PhoneNumber::_internal_type() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::Lab3::Person_PhoneType>(_impl_.type_);
}
inline void Person_PhoneNumber::_internal_set_type(::Lab3::Person_PhoneType value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.type_ = value;
}
...
inline const ::std::string& Person::name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Lab3.Person.name)
...
PROTOBUF_ALWAYS_INLINE void Person::set_name(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:Lab3.Person.name)
}
inline ::std::string* PROTOBUF_NONNULL Person::mutable_name()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:Lab3.Person.name)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Person::release_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Lab3.Person.name)
  if ((_impl_._has_bits_[0] & 0x00000001U) == 0) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000001U;
...
inline void Person::set_allocated_name(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Lab3.Person.name)
}
...
inline ::int32_t Person::id() const {
  // @@protoc_insertion_point(field_get:Lab3.Person.id)
  return _internal_id();
}
inline void Person::set_id(::int32_t value) {
  _internal_set_id(value);
  _impl_._has_bits_[0] |= 0x00000004U;
  // @@protoc_insertion_point(field_set:Lab3.Person.id)
}
...
inline const ::std::string& Person::email() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Lab3.Person.email)
...
PROTOBUF_ALWAYS_INLINE void Person::set_email(Arg_&& arg, Args_... args) {
  ...
  // @@protoc_insertion_point(field_set:Lab3.Person.email)
}
inline ::std::string* PROTOBUF_NONNULL Person::mutable_email()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:Lab3.Person.email)
  return _s;
}
...
inline ::std::string* PROTOBUF_NULLABLE Person::release_email() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:Lab3.Person.email)
...
inline void Person::set_allocated_email(::std::string* PROTOBUF_NULLABLE value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Lab3.Person.email)
}
...
inline ::Lab3::Person_PhoneNumber* PROTOBUF_NONNULL Person::mutable_phones(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:Lab3.Person.phones)
  return _internal_mutable_phones()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>* PROTOBUF_NONNULL Person::mutable_phones()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:Lab3.Person.phones)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_phones();
}
inline const ::Lab3::Person_PhoneNumber& Person::phones(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Lab3.Person.phones)
  return _internal_phones().Get(index);
}
inline ::Lab3::Person_PhoneNumber* PROTOBUF_NONNULL Person::add_phones()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::Lab3::Person_PhoneNumber* _add = _internal_mutable_phones()->Add();
  // @@protoc_insertion_point(field_add:Lab3.Person.phones)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>& Person::phones() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:Lab3.Person.phones)
  return _internal_phones();
}
inline const ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>&
Person::_internal_phones() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.phones_;
}
inline ::google::protobuf::RepeatedPtrField<::Lab3::Person_PhoneNumber>* PROTOBUF_NONNULL
...
inline ::Lab3::Person* PROTOBUF_NONNULL AddressBook::mutable_people(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:Lab3.AddressBook.people)
  return _internal_mutable_people()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField<::Lab3::Person>* PROTOBUF_NONNULL AddressBook::mutable_people()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:Lab3.AddressBook.people)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_people();
}
inline const ::Lab3::Person& AddressBook::people(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Lab3.AddressBook.people)
  return _internal_people().Get(index);
}
inline ::Lab3::Person* PROTOBUF_NONNULL AddressBook::add_people()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::Lab3::Person* _add = _internal_mutable_people()->Add();
  // @@protoc_insertion_point(field_add:Lab3.AddressBook.people)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::Lab3::Person>& AddressBook::people() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:Lab3.AddressBook.people)
  return _internal_people();
}
inline const ::google::protobuf::RepeatedPtrField<::Lab3::Person>&
AddressBook::_internal_people() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.people_;
}
inline ::google::protobuf::RepeatedPtrField<::Lab3::Person>* PROTOBUF_NONNULL
...
template <>
struct is_proto_enum<::Lab3::Person_PhoneType> : std::true_type {};
template <>
inline const EnumDescriptor* PROTOBUF_NONNULL GetEnumDescriptor<::Lab3::Person_PhoneType>() {
  return ::Lab3::Person_PhoneType_descriptor();
}
